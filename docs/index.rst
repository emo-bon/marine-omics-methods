...
FAIR-EASE jupyter-book on the [marine omics pilot](https://lab.fairease.eu/book-marine-omics-observation/) is also updated in parallel and with extra analysis resources

FAIR-EASE [GitHub](https://github.com/fair-ease), [website](https://fairease.eu/) and [linkedIn](https://www.linkedin.com/company/fair-ease/).
.. toctree::
   :maxdepth: 2
