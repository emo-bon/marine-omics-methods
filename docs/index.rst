...
FAIR-EASE jupyter-book on the `marine omics pilot <https://lab.fairease.eu/book-marine-omics-observation/>`_ is also updated in parallel and with extra analysis resources

FAIR-EASE `GitHub <https://github.com/fair-ease>`_, `website <https://fairease.eu/>`_ and `linkedIn <https://www.linkedin.com/company/fair-ease/>`_.
